...
BHK_RANGES = {
    "1BHK": {
        "Modular Kitchen": (70000, 100000),
        "Wardrobe & Storage": (150000, 200000),
        "Furniture": (23000, 50000),
        "Electrical & Lighting": (250000, 300000),
        "Painting & Wall Finish": (180000, 230000),
        "False Ceiling & POP": (40000, 60000),
        "Bathroom & Plumbing": (60000, 90000),
        "Appliances": (70000, 100000),
        "Curtains / Blinds": (150000, 200000),
        "Deep Cleaning & Installation": (70000, 100000),
    },
